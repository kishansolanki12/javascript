bv   /**
        ...
        2. toExponential()  -> convert to Exponential Number
        3. toPrecision()    -> set to Precision number
        4. toFixed()        -> set to fixed value of Number
        5. valueOf()        -> 
 */
...
// console.log((1258459).toExponential(4));

// console.log((1.2584595).toPrecision())
// console.log((1.2584595).toPrecision(5))


// console.log((2.552).toFixed());
// console.log((2.552).toFixed(2));
...
console.log(Number.isSafeInteger(12351589512466254));
// parseInt("-10.33");
// parseInt("10");
// parseInt("10.33");
// parseInt("10 20 30");
